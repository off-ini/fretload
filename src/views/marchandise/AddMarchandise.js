...
class AddMarchandise extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit = (e) => {
    ...
    .then(res => {
        dispatch({
          type:actions.CREATE_MARCHANDISE, 
          payload:res.data
        });
        this.handleNull();
          ...
          <ModalBody>
                ...
                <Row>
                    <Col sm={4} md={4} xl={4} xs={4}>
                        <Label className="form-group has-float-label">
                        <NumberFormat format="#######" customInput={Input} onValueChange={(values) => this.onValueChangeQ(values)} />
                            <span>Quantité</span>
                        </Label>
                    </Col>
                    ...
                    <Col sm={4} md={4} xl={4} xs={4}>
                        <Label className="form-group has-float-label">
                        <NumberFormat format="#######" customInput={Input} onValueChange={(values) => this.onValueChangeP(values)} />
                            <span>Poid (Tone)</span>
                        </Label>
                    </Col>
                    ...
                    <Col sm={4} md={4} xl={4} xs={4}>
                        <Label className="form-group has-float-label">
                        <NumberFormat format="#######" customInput={Input} onValueChange={(values) => this.onValueChangeV(values)} />
...
export default connect(null, mapDispatchToProsps)(AddMarchandise);
