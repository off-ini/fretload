...
import * as propositionActionsCreator from '../../store/actions/PropositionActions';
import {
  Row,
  Col,
  Button,
...
class AddMission extends Component {
  ...
  handleSubmit = (e) => {
    ...
    let {proposition, vehicules, chauffeurs} = this.state;
    let vehicule_ids = [];
    let chauffeur_ids= [];
...

{
  ...
  const mapDispatchToProsps = dispatch => {
    return {
      ...
      detail: (id) => propositionActionsCreator.detail(id)
    }
  }
