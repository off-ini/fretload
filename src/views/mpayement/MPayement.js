...
import AddMPayement from './AddMPayement';
import EditMPayement from './EditMPayement';
import MPayementListItem from './MPayementListItem';
{/*import MPayementMenu from './MPayementMenu';*/}

class MPayement extends Component {
    constructor(props) {
        super(props);
    ...
    all()
    {
        ...
        all().then(res => {
          dispatch({type:actions.ALL_M_PAYEMENTS, payload:res.data.data});
          this.setState({
    ...
    handleDelete = (id) => {
      ...
      deleted(id).then(res => {
        dispatch({type:actions.DELETE_M_PAYEMENT, payload:res.data.id});
...
const mapStateToProps = state => {
    return {
      mpayements: state.ModePayementReducer.mpayements,
...
export default injectIntl(connect(mapStateToProps, mapDispatchToProsps)(MPayement));
