...
class EditMPayement extends Component {
  constructor(props) {
    super(props);
  ...
  get = () => {
    const {mpayements, id} = this.props;
    const mpayement = mpayements.find( v => v.id === id);
    if(mpayement)
    {
        this.setValues(mpayement)
    }
  }
...
export default connect(mapStateToProps, mapDispatchToProsps)(EditMPayement);
