...
class Adresse extends Component {
    ...
    all = () =>
    {
      this.setState({loading:true});
        ...
        all().then(res => {
        dispatch({type:actions.ALL_ADRESSES, payload:res.data.data});
        this.setState({
    ...
    handleDelete = (id) => {
      ...
      deleted(id).then(res => {
        dispatch({type:actions.DELETE_ADRESSE, payload:res.data.id});
...
export default injectIntl(connect(mapStateToProps, mapDispatchToProsps)(Adresse));
