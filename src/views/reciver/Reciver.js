...
import AddReciver from './AddReciver';
import EditReciver from './EditReciver';
import ReciverListItem from './ReciverListItem';
{/*import ReciverMenu from './ReciverMenu';*/}
...
class Reciver extends Component {
    ...
    all()
    {
      this.setState({loading:true});
        ...
        all().then(res => {
        dispatch({type:actions.ALL_RECIVERS, payload:res.data.data});
        this.setState({
    ...
    handleDelete = (id) => {
      ...
      deleted(id).then(res => {
        dispatch({type:actions.DELETE_RECIVER, payload:res.data.id});
...
export default injectIntl(connect(mapStateToProps, mapDispatchToProsps)(Reciver));
