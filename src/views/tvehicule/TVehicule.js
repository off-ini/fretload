...
import AddTVehicule from './AddTVehicule';
import EditTVehicule from './EditTVehicule';
import TVehiculeListItem from './TVehiculeListItem';
{/*import TVehiculeMenu from './TVehiculeMenu';*/}

class TVehicule extends Component {
    constructor(props) {
        super(props);
    ...
    all()
    {
      this.setState({loading:true});
        ...
        all().then(res => {
          dispatch({type:actions.ALL_T_VEHICULES, payload:res.data.data});
          this.setState({
    ...
    handleDelete = (id) => {
      ...
      deleted(id).then(res => {
        dispatch({type:actions.DELETE_T_VEHICULE, payload:res.data.id});
...
export default injectIntl(connect(mapStateToProps, mapDispatchToProsps)(TVehicule));
